...
if(NOT DEFINED STM32_CUBEMX_PROJECT_PATH)
    set(STM32_CUBEMX_PROJECT_PATH ${ROOT_DIR}/Libs/node-v4-h7-ioc)
endif()
...
if(IMAGE_KIND STREQUAL "standalone" OR IMAGE_KIND STREQUAL "bootloader")
    ...
    math(EXPR APP_VECTOR_TABLE_OFFSET_HEX "${BOOTLOADER_RESERVED_KB} * 1024" OUTPUT_FORMAT HEXADECIMAL)
    add_definitions(-DUSER_VECT_TAB_ADDRESS=1)
    add_definitions(-DVECT_TAB_OFFSET=${APP_VECTOR_TABLE_OFFSET_HEX}U)
endif()
